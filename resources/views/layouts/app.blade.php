...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <meta name="Description" content="A very artsy website!">
        <meta name="keywords" content="art, drawing, images, games, tv, movies"/>
    ...
    <nav class='navigation'>
        <div class="wrapper">
            <ul class="navigation-ul">
                <li class='dropdown'>
                    <a href='#'>
                        <img src='{{ url("storage/uploads/icons/dropdown.png") }}' alt='dropdown button'>
                    </a>
                </li>
                ...
                <li class='{{ Route::currentRouteNamed('profile') ? 'currentURL' : '' }}'>
                    <a class='navigation-username' href='{{url("profile/".Auth::user()->username )}}'>
                        <img class='profile-picture' src='{{url("storage/uploads/profile_pictures/edited/".Auth::user()->image_file_name)}}' alt='{{url("storage/uploads/profile_pictures/edited/".Auth::user()->image_file_name)}}'>
